...
for current_namespace in list_of_namespaces:
  ...
  if current_namespace=="default" or current_namespace=="velero" or current_namespace=="anchore" or current_namespace=="filebeat" or current_namespace=="dynatrace" or current_namespace=="busybox" or current_namespace=="istio-cosmote"  or current_namespace=="istio-system" or current_namespace=="kube-system" or current_namespace=="metricbeat" or current_namespace=="monitoring"  or current_namespace=="tracing":
   continue
